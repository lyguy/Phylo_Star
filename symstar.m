...
%%
%   Generates Maple file for <ntaxa>-taxa <treename tree>, with abitrary edge
%   lengths a_i
%%
...
% since this changes the polynomials i think.
...
% for ii = 1:NumTrees
%     fprintf(outfid,'%s\n',['# Tree', sprintf('%i',ii), ' topology ', getnewickstr(treeforest{ii},'Distances','false')]);
% end
